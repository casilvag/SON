  ...
  return (
    <section id="galerie" className="py-20 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-48 left-1/4 text-yellow-400 text-lg opacity-40">♬</div>
        <div className="absolute bottom-64 right-1/3 text-red-400 text-2xl opacity-45">♫</div>
        <div className="absolute top-20 right-1/2 text-blue-400 text-xl opacity-40">♪</div>
        <div className="absolute bottom-20 left-1/2 text-yellow-400 text-lg opacity-45">♬</div>
